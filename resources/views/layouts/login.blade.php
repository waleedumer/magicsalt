...
<link href="{{ asset('public/') }}/images/favicon.png" rel="icon" type="image/png">
    ...
    <style>
            ...
            .login-block {
                ...
                .banner-sec{background:url(https://cdn.pixabay.com/photo/2015/11/17/17/41/salt-lamps-1047941_960_720.jpg)  no-repeat center bottom; background-size:cover; min-height:500px; border-radius: 10px 0 0 10px; padding:0;}
                ...
                .login-sec h2{margin-bottom:30px; font-weight:500; text-transform: uppercase; font-size:18px; color: #FE920B;}
                .logo-login {text-align: center;}
                .login-logo img {width: 35%;padding-bottom: 20px;}
                .logo-login img {width: 30%;padding-bottom: 20px;}
                .btn-login{background: #ee880e; color:#fff; font-weight:600;}
                .banner-text{width:70%; position:absolute; bottom:40px; padding-left:20px;}
                .banner-text h2{color:#fff; font-weight:600;}
                .banner-text h2:after{content:" "; width:100px; height:5px; background:#FFF; display:block; margin-top:20px; border-radius:3px;}
                .banner-text p{color:#fff;}
                .copy-text a{color:#ee880e !important; font-weight:500; text-decoration:none;}
        </style>
</head>
<body>
        <main class="">
